...
signal chest_interactable_activated
signal chest_interactable_deactivated
...
func _ready() -> void:
	...
	if player:
		chest_interactable_activated.connect(player.on_interaction_started)
		chest_interactable_deactivated.connect(player.on_interaction_ended)
...
func on_interactable_activated() -> void:
	chest_interactable_activated.emit()
	in_range = true
...
func on_interactable_deactivated() -> void:
	...
	is_chest_open = false
	chest_interactable_deactivated.emit()
	in_range = false
